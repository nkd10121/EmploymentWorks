...
/// </summary>
std::list<std::vector<std::string>> LoadCSV::GetLoadResourcePath(std::string stageId)
{
	//戻り値
...
TrapBase::TrapInfo LoadCSV::LoadTrapStatus(const char* trapName)
{
	TrapBase::TrapInfo ret;
